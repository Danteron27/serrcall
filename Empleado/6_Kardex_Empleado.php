...
<body>
<form action="../Administrador/reporte_kardex.php"> 
...
<table cellspacing="0" class="productos">
            ...
            <tbody>
                ...
                <tr>
                    <td class="gris">Camioneta</td>
                    <td class="gris">Ozuna</td>
                    <td class="gris">0000-00-00</td>
                    <td class="gris">0000-00-00</td>
                    <td class="gris">2</td>
                    <td class="gris">2</td>
                </tr>
            ...
            <tfoot>
                <tr>
                    <th colspan="8" class="text-center">Serrcall</th>
