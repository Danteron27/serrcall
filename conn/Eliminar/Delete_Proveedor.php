...
$miConsulta=$miPDO->prepare("DELETE FROM proveedores WHERE Pro_ID='$Pro_ID';");
//ejecuta la sentencia SQL
$miConsulta->execute();
//direccion de datos
header('location: ../../Administrador/3_Proveedores_Administrador.php');
}
    $consull=$miPDO->prepare("SELECT * FROM proveedores WHERE Pro_ID='$Pro_ID';");
    $consull->execute();
    $proveedores=$consull->fetch();
...
<center>
    ...
    <tr>
                    ...
                    <th class="larg text-center"># Proveedor</th><td><?=$proveedores['Pro_ID']?></td>
                    </tr><tr>
                    <th class="larg text-center">Nombre de proveedor</th><td><?=$proveedores['Pro_Nombre']?></td>
                    </tr><tr>
                    <th class="larg text-center">Nit</th><td><?=$proveedores['Pro_Nit']?></td>
                    </tr><tr>
                    <th class="larg text-center">Email</th><td><?=$proveedores['Pro_Email']?></td>
                    </tr><tr>
                    <th class="larg text-center">Celular</th><td><?=$proveedores['Pro_Celular']?></td>
                    </tr><tr>
                    <th class="larg text-center">Dirección</th><td><?=$proveedores['Pro_Direccion']?></td>
                
                </tr>
                </table>
                <br>
        <input type="submit" value="Eliminar" class="btn btn-danger" name="eliminar">  <a href="../../Administrador/3_Proveedores_Administrador.php"><button type="button" class="btn btn-success" data-bs-dismiss="modal">Cancelar</button></a>
    </form>       
  </div>
</center>
