...
$miConsulta=$miPDO->prepare("DELETE FROM clientes WHERE Cli_ID='$Cli_ID';");
//ejecuta la sentencia SQL
$miConsulta->execute();
//direccion de datos
header('location: ../../Administrador/7_Clientes_Administrador.php');
}
 $consull=$miPDO->prepare("SELECT * FROM clientes WHERE Cli_ID='$Cli_ID';");
    $consull->execute();
    $clientes=$consull->fetch();
...
<center>
    ...
    <tr>
                    ...
                    <th class="larg text-center"># Cliente</th><td><?=$clientes['Cli_ID']?></td>
                    </tr><tr>
                    <th class="larg text-center">Cedula</th><td><?=$clientes['Cli_Cedula']?></td>
                    </tr><tr>
                    <th class="larg text-center">Nombre</th><td><?=$clientes['Cli_Nombre']?></td>
                    </tr><tr>
                    <th class="larg text-center">Celular</th><td><?=$clientes['Cli_Celular']?></td>
                    </tr><tr>
                    <th class="larg text-center">Email</th><td><?=$clientes['Cli_Email']?></td>
                    </tr><tr>
                    <th class="larg text-center">Ciudad</th><td><?=$clientes['Cli_Ciudad']?></td>
                    </tr><tr>
                    <th class="larg text-center">Dirección</th><td><?=$clientes['Cli_Direccion']?></td>
                    </tr>

                </table>
                <br>
        <input type="submit" value="Eliminar" class="btn btn-danger" name="eliminar">  <a href="../../Administrador/7_Clientes_Administrador.php"><button type="button" class="btn btn-success" data-bs-dismiss="modal">Cancelar</button></a>
    </form>       
  </div>
</center>
