...
$miConsulta=$miPDO->prepare("DELETE FROM novedades WHERE Nov_ID='$Nov_ID';");
//ejecuta la sentencia SQL
$miConsulta->execute();
//direccion de datos
header('location: ../../Administrador/4_Novedades_Administrador.php');
}
    $consull=$miPDO->prepare("SELECT * FROM novedades WHERE Nov_ID='$Nov_ID';");
    $consull->execute();
    $novedades=$consull->fetch();
...
<center>
    ...
    <tr>
                    ...
                    <th class="larg text-center"># Novedad</th><td><?=$novedades['Nov_ID']?></td>
                    </tr><tr>
                    <th class="larg text-center">Descripcion</th><td><?=$novedades['Nov_Descripcion']?></td>
                    </tr><tr>
                    <th class="larg text-center">Tipo</th><td><?=$novedades['Nov_Tipo']?></td>
                    </tr><tr>
                    <th class="larg text-center">Fecha</th><td><?=$novedades['Nov_Fecha']?></td>
                    </tr><tr>
                    <th class="larg text-center">Producto</th><td><?=$novedades['Prd_ID']?></td>
                    </tr><tr>
                    <th class="larg text-center">Cliente</th><td><?=$novedades['Cli_ID']?></td>
                
                </tr>
                </table>
                <br>
        <input type="submit" value="Eliminar" class="btn btn-danger" name="eliminar">  <a href="../../Administrador/4_Novedades_Administrador.php"><button type="button" class="btn btn-success" data-bs-dismiss="modal">Cancelar</button></a>
    </form>       
  </div>
</center>
    ...
    <div class="barra_lateral">
          ...
          <div class="recuadros">
              ...
              <h4 class="titulo">Proovedores</h4>
